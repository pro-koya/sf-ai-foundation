...
- インストール手順 (`npm install -g @sf-ai-foundation/sfai-core`)
...
1. npm publish: `@sf-ai-foundation/sfai-core` を npm に公開 → `npm install -g` が使えるようになる
2. plugin.json の install.command を更新 (`npm install -g @sf-ai-foundation/sfai-core`)
